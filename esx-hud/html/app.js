...
function closeMenu() {
    ...
    $.post("https://esx-hud/closeMenu");
}
function restartHud() {
    closeMenu();
    $.post("https://esx-hud/restartHud");
}
function resetStorage() {
    closeMenu();
    $.post("https://esx-hud/resetStorage");
}
function showOutMap() {
    $.post("https://esx-hud/showOutMap");
}
function showOutCompass() {
    $.post("https://esx-hud/showOutCompass");
}
function showFollowCompass() {
    $.post("https://esx-hud/showFollowCompass");
}
function openMenuSounds() {
    $.post("https://esx-hud/openMenuSounds");
}
function resetHudSounds() {
    $.post("https://esx-hud/resetHudSounds");
}
function checklistSounds() {
    $.post("https://esx-hud/checklistSounds");
}
function showMapNotif() {
    $.post("https://esx-hud/showMapNotif");
}
function showFuelAlert() {
    $.post("https://esx-hud/showFuelAlert");
}
function showCinematicNotif() {
    $.post("https://esx-hud/showCinematicNotif");
}
function dynamicHealth() {
    $.post("https://esx-hud/dynamicHealth");
}
function dynamicArmor() {
    $.post("https://esx-hud/dynamicArmor");
}
function dynamicHunger() {
    $.post("https://esx-hud/dynamicHunger");
}
function dynamicThirst() {
    $.post("https://esx-hud/dynamicThirst");
}
function dynamicStress() {
    $.post("https://esx-hud/dynamicStress");
}
function dynamicOxygen() {
    $.post("https://esx-hud/dynamicOxygen");
}
function dynamicEngine() {
    $.post("https://esx-hud/dynamicEngine");
}
function dynamicNitro() {
    $.post("https://esx-hud/dynamicNitro");
}
function ToggleMapShape() {
    $.post("https://esx-hud/ToggleMapShape");
}
function changeFPS() {
    $.post("https://esx-hud/changeFPS");
}
function ToggleMapBorders() {
    $.post("https://esx-hud/ToggleMapBorders");
}
function HideMap() {
    $.post("https://esx-hud/HideMap");
}
function changeCompassFPS() {
    $.post("https://esx-hud/changeCompassFPS");
}
function showCompassBase() {
    $.post("https://esx-hud/showCompassBase");
}
function showStreetsNames() {
    $.post("https://esx-hud/showStreetsNames");
}
function showPointerIndex() {
    $.post("https://esx-hud/showPointerIndex");
}
function showDegreesNum() {
    $.post("https://esx-hud/showDegreesNum");
}
function cinematicMode() {
    $.post("https://esx-hud/cinematicMode");
}
